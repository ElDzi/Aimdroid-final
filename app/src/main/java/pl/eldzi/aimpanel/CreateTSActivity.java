...
public class CreateTSActivity extends AppCompatActivity {
    ...
    @Subscribe
    public void onEvent(TeamSpeakServerCreateEvent e) {
        try {
            ...
            if (stat.equalsIgnoreCase("ok")) {
                ...
                ab.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(CreateTSActivity.this, ProfileActivity.class);
                        startActivity(i);
                    }
                });
                ...
                data.setText("  DANE DO SERWERA TS3 #" + lastID + " :" + nl + nl + "  Game Port:        " + p.getInt("game_port") + nl + nl + "  RCON Port:         " + p.getInt("rcon_port") + nl + nl + "  RCON Password:           " + p.getString("rcon_password") + nl + nl + nl + "ZAPISZ TE DANE!!!");

            } else {
                Toast.makeText(getApplicationContext(), "Nie mozna utworzyc serwera!", Toast.LENGTH_LONG).show();
            }
